...
RunName='TwoLineRegression'	## This is the name of the run. You need to make a unique name each time you run.
...
ROULETTE=1			## Percent of individuals selected through roulette (divided by 10)
