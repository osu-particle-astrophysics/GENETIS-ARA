...
// call format: ./a.out start/cont NPOP 1 1 repro_no cross_no ratio_int
// start/cont: start if running for the first generation, cont if evolving any gen after
// NPOP: number of individuals in the generation (int)
// 1: used for geoscale factor
// repro_no: number of individuals formed through reproduction
// cross_no: number of individuals formed through crossover
// ratio_int: percent of individuals selected through tournament * 10 (ex: 10 == 100% tournament)
...
const float crossover_percent = 0.75;
